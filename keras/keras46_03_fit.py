...
print(xy_train[0]) #0~31 batch가 5이므로 160장이므로 32장으로 나뉘어짐
...
hist = model.fit(xy_train[0][0],xy_train[0][1],epochs=10,batch_size = 32,validation_split=0.1)# batch를 최대로 잡으면 이렇게도 가능.
