...
model.load_weights("./_save/keras23_5_save_weights2.h5") #컴파일은 해줘야함,* fit은 하면안됨!
...
# model = load_model("./_save/keras23_3_save_model.h5") #fit 뒤에서 save하니 모두 저장되었음(가중치,모델).여기서 부르면 결과 똑같음. fit전에 로드하면 가중치 갱신으로 결과바뀜.
...
# load 하기전 
#loss :  14.371272087097168
# r2스코어 :  0.828059755260371

#save model은 모델과 가중치 모두 저장됨. save weight는 가중치마 저장됨.
