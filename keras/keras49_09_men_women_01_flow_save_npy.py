...
np.save('d:/study_data/_save/_npy/men_women_02/keras49_09_train_x.npy', arr =x_train)
np.save('d:/study_data/_save/_npy/men_women_02/keras49_09_train_y.npy', arr =y_train)
np.save('d:/study_data/_save/_npy/men_women_02/keras49_09_test_x.npy', arr =x_test)
np.save('d:/study_data/_save/_npy/men_women_02/keras49_09_test_y.npy', arr =y_test)