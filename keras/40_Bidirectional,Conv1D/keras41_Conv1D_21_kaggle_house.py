...
x_train = x_train.reshape(1168,74,1)
x_test = x_test.reshape(292,74,1)


#2.모델구성
model = Sequential()
model.add(Conv1D(200,2,activation='relu', input_shape=(74,1))) 
model.add(Flatten())
...
#LSTM
# loss:  140337.609375
# RMSE :  196057.71423303583

#Conv1D
# loss:  16500.75390625
# RMSE :  26662.455350743032