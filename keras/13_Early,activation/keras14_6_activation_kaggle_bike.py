...
earlyStopping =EarlyStopping(monitor = 'val_loss',patience=40,mode='min',restore_best_weights=True,verbose=1)
model.fit(x_train, y_train, epochs=800, batch_size=500,validation_split=0.2,callbacks=earlyStopping, verbose=2)
