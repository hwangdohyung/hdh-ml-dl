...
def solution_model():
    ...
    train_generator = train_datagen.flow_from_directory(
        #Your Code Here)
         'tmp/horse-or-human/', # 이 경로의 이미지파일을 불러 수치화
    target_size=(300,300),# 크기들을 일정하게 맞춰준다.
    batch_size=10,
    class_mode='binary', 
    ...
    model.compile(loss= 'binary_crossentropy',optimizer='adam')#Your Code Here#)

    model.fit(train_generator,epochs=1,verbose=1,batch_size=1000)#Your Code Here#)
    ...
    acc = accuracy_score(validation_generator.classes,y_predict)
