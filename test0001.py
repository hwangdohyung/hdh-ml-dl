...
parameters_lgb = [{'boosting_type': ['gbdt'], 'learning_rate': [0.1],
                   'max_depth': [5, 6, 8, ], 'n_estimators': [300], 'num_leaves': [10,30, 40], 
                   'subsample': [0.5, 0.6], 'subsample_for_bin': [200, 300], 'subsample_freq': [0, 1, 2, ]}]
